...
namespace KMS.IssueTracker.Migrations
{
    ...
    [Migration("20220701110925_IssueTrackerEntities")]
    partial class IssueTrackerEntities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KMS.IssueTracker.Issues.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("KMS.IssueTracker.Issues.Issue", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("KMS.IssueTracker.Issues.IssueLabel", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("KMS.IssueTracker.Labels.Label", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("KMS.IssueTracker.Projects.Project", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("KMS.IssueTracker.Issues.Comment", b =>
                {
                    b.HasOne("KMS.IssueTracker.Issues.Issue", null)
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("KMS.IssueTracker.Issues.IssueLabel", b =>
                {
                    ...
                    b.HasOne("KMS.IssueTracker.Labels.Label", null)
                        .WithMany()
