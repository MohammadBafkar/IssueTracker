...
public class IssueTrackerDbContext :
    AbpDbContext<IssueTrackerDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    private static ILoggerFactory ContextLoggerFactory
        => LoggerFactory.Create(b => b.AddDebug().AddConsole().AddFilter("", LogLevel.Information));
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(IssueTrackerConsts.DbTablePrefix + "YourEntities", IssueTrackerConsts.DbSchema);
        ...
        {
            b.ConfigureByConvention();
            b.HasOne<Label>().WithMany().HasForeignKey(l => l.LabelId);
        });

        builder.Entity<Issue>(b =>
        {
            b.ConfigureByConvention();
            b.HasMany(i => i.Labels).WithOne();
            b.HasMany(i => i.Comments).WithOne();
        });
